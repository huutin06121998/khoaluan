...
$(document).on("input","#Search", _.throttle(function(){
  ...
  $(document).on('click','#exp',function () {
    $("#tb_exp").table2excel({
      exclude : ".noExl",
      name    : "Danh sách điểm tổng kết cả năm",
      filename: "Danhsachdiemcanam"
    }); 
  });